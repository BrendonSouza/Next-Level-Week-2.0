...
É uma experiência online criada pela Rocketseat de uma semana com muito conteúdo prático, desafios, hacks e um projeto que nos ajudam a avançar para o próximo nível e impulsionar a nossa carreira.
...
```
# Clone o repositório
$ git clone https://github.com/Ljuniorcode/Next-Level-Week-2.0.git
```
